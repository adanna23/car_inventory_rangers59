...
from car_inventory.models import User, Drone, drone_schema, drones_schema, db
...
def create_car(current_user_token):
    ...
    fuel_capacity = request.json['fuel_capacity']
    ...
    drone = Drone(name,description,price, fuel_capacity, miles,max_speed,dimensions, weight,cost_of_prd,series,user_token = user_token )
...
def update_drone(current_user_token, id):
    ...
    drone.miles = request.json['miles']
    drone.fuel_capacity = request.json['fuel_capacity']
